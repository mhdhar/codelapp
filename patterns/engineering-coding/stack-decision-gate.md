...
date: "2026-07-09"
license: "CC-BY-4.0"
related: ["integration-decision-checklist", "service-provisioning-decision-pass", "pre-build-intent-capture"]
---
...
Before anything else, ask me in one message and wait: (1) what I'm building, (2) must-have features, (3) constraints (deadline, team size, existing infra). If I skip (3), assume solo dev with no hard deadline, and say so.
```
