...
Then rank all 5 for [PLATFORM/CONTEXT, e.g. "cold email subject line" or
"blog post title for search traffic"] and say which one you'd actually
ship and why.

Piece summary: [1-2 SENTENCES ON WHAT THE PIECE ACTUALLY SAYS]
```
