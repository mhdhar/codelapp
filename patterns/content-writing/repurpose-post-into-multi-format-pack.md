...
"Read this post and state its single core argument in one sentence, plus
the 3 supporting points that prove it. Nothing else. Post: [PASTE POST]"
...
"Using this core argument and its 3 supporting points, write three
separate pieces:
1. A [PLATFORM] thread of 6-8 posts, each under [CHAR LIMIT] characters,
   one point per post, hook in post 1, no numbering like '1/8'.
...
Core argument and supporting points: [PASTE FROM STEP 1]"
