...
date: "2026-07-09"
license: "CC-BY-4.0"
related: ["idea-to-prd", "dependency-ordered-build-sequencing", "task-to-self-verifying-brief"]
---
...
Stop after the ticket list and wait for my review. Once I approve, order the tickets into a build sequence respecting the dependencies you listed, and group them into a first milestone (P0 only) and a second milestone (P1+).
```
