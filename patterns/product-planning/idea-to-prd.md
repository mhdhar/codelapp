...
## The pattern
```text
Write a PRD for this idea: [ROUGH IDEA].
...
Keep the whole thing under 500 words. Ask me clarifying questions first if the idea is too vague to spec confidently, don't guess and fill gaps silently.
```
