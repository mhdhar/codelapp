...
## The pattern
```text
Visit each competitor URL I list at the bottom of this prompt and read their homepage, pricing, and features pages. Then:
...
3. Cross-reference those gaps against my product description below to find where I already have a real, verifiable advantage
...
My product (two or three lines on what it does and for whom):
Competitor URLs:
```
