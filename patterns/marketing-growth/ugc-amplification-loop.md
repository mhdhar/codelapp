---
title: "Turn Organic Mentions Into a Repeatable Amplification Loop"
slug: "ugc-amplification-loop"
format: "loop"
...
est_time: "10 min"
models: ["any"]
summary: "A recurring weekly check that turns scattered organic mentions into a ranked, actionable queue."
author: "codel"
author_handle: ""
date: "2026-07-09"
license: "CC-BY-4.0"
related: ["testimonial-extraction-from-raw-feedback", "launch-thread-from-shipped-feature"]
---
...
## Real example output
Previous queue: None, first run.

New mentions this week:
1. X post from @priya_builds (2,400 followers): "switched our whole team over to this from spreadsheets last month, saved probably 5 hours a week just on status updates" - worth amplifying. Specific claim, identifiable source, credible follower count. Action: reply publicly, then DM to ask permission to quote on the site.
2. G2 review, 5 stars, from "Verified User in Marketing": "great product, does what it says" - noise, dropped. No specific detail, no attribution.
3. Reddit comment in r/ProductManagement from u/throwaway_pm: "been using this for 3 months, the reporting feature alone is worth the price, went from a full day building the monthly deck to about 40 minutes" - worth amplifying. Specific before/after number, but anonymous account, so ranks below #1. Action: reply with a thank-you, ask if they'd do a short quote under any name they're comfortable with.

Ranked queue:
1. @priya_builds - specific claim, public identity, high follower count
2. u/throwaway_pm - specific claim, anonymous account

Updated queue:
**Done this week:** none yet, both are new.
**Pending:** #1 (new), #2 (new). Nothing carried over, first run.
